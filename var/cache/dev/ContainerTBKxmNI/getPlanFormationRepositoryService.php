 ...
 */
class getPlanFormationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlanFormationRepository' shared autowired service.
     *
     * @return \App\Repository\PlanFormationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlanFormationRepository.php';

        return $container->privates['App\\Repository\\PlanFormationRepository'] = new \App\Repository\PlanFormationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
