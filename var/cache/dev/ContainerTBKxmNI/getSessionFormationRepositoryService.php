 ...
 */
class getSessionFormationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SessionFormationRepository' shared autowired service.
     *
     * @return \App\Repository\SessionFormationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SessionFormationRepository.php';

        return $container->privates['App\\Repository\\SessionFormationRepository'] = new \App\Repository\SessionFormationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
