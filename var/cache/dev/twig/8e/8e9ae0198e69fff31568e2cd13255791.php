...
class __TwigTemplate_8b6bd02405054b8b3397fa72e38ba21a extends Template
{
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous etes connecté en tant que {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Deconnexion</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\wamp64\\www\\FormArmor\\templates\\security\\login.html.twig");
    }
}
